...
model_path_clf = os.path.join(r'D:\Matakuliah Semester 5\Pembelajaran Mesin dan Pembelajaran Mendalam\UTS\Projek UTS PMDPM_Kelas_NamaSB\BestModel_CLF_RandomForest_Numpy.pkl')
model_path_reg = os.path.join(r'D:\Matakuliah Semester 5\Pembelajaran Mesin dan Pembelajaran Mendalam\UTS\Projek UTS PMDPM_Kelas_NamaSB\BestModel_REG_LassoRegression_Numpy.pkl')
